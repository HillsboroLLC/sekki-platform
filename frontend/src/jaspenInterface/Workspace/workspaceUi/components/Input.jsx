...
export default function Input({
  ...
  const wrapStyle = { marginBottom: 'var(--jas-space-4)', ...customStyle };

  const renderField = () => {
    if (type === 'textarea') {
      return (
        <textarea
          className="jas-form-input"
    ...
    return <input className="jas-form-input" style={inputStyle} type={type} {...props} />;
  };

  return (
    <div className={`jas-form-group ${className}`} style={wrapStyle}>
